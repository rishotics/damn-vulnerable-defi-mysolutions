...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackPoolFactory = await ethers.getContractFactory('AttackPool', deployer);
        this.poolAttack = await AttackPoolFactory.deploy(this.pool.address);

        this.poolAttack.connect(attacker).attack();
    });
