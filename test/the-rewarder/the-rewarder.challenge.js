...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const HackRewardFactory = await ethers.getContractFactory('HackReward', deployer);
        this.hackReward = await HackRewardFactory.deploy(this.rewarderPool.address, this.rewardToken.address, this.liquidityToken.address, this.flashLoanPool.address);
        await this.hackReward.connect(attacker).hack();
